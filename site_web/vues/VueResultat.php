	...
	class VueResultat extends Vue{
		...
		public function statutFinalJoueur($scoreJoueur,$idJoueur,$scoreAdversaire,$idAdversaire){
			...
			if ($scoreJoueur>$scoreAdversaire){
				$reqVictoire="UPDATE Membres SET nbPartiesGagnees=nbPartiesGagnees+1 WHERE idMembre={$idJoueur}; UPDATE Membres SET points=points+{$scoreJoueur} WHERE idMembre={$idJoueur};";
				...
				$reqDefaite="UPDATE Membres SET points=points+{$scoreJoueur} WHERE idMembre={$idJoueur};";
				...
				$reqAddPoints="UPDATE Membres SET points=points+{$scoreJoueur} WHERE idMembre={$idJoueur}; UPDATE Membres SET points=points+{$scoreAdversaire} WHERE idMembre={$idAdversaire};";
